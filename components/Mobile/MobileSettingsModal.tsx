...
import { AppSettings, AiModel, ThinkingLevel, WritingStyle, NarrativePerspective } from '../../types';
...
const IMAGE_MODELS_GEMINI = [
  { id: 'gemini-2.5-flash-image', label: 'Nano Banana (Gemini 2.5 Flash Image) - [Hỗ trợ Key Free]' },
  { id: 'gemini-3.1-flash-image-preview', label: 'Nano Banana 2 (Gemini 3.1 Flash Image) - [Cần Key Trả Phí]' },
  { id: 'gemini-3-pro-image-preview', label: 'Nano Banana Pro (Gemini 3 Pro Image) - [Cần Key Trả Phí]' },
];
                  ...
                  <div className="space-y-4 pt-2 border-t border-white/5 animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        >
                          <optgroup label="Mô hình Gemini" className="bg-black text-neutral-500">
                      ...
                      <p className="text-[8px] text-neutral-600 font-bold uppercase italic px-1 leading-relaxed">
                        * Các model Nano Banana được cung cấp bởi Google AI Studio. Lưu ý: Model 2.5 Flash thường hỗ trợ Key Free, các model 3.x yêu cầu Key từ dự án đã bật Billing (Thanh toán).
                      </p>
                    </div>
