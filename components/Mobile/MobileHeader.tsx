...
export const MobileHeader: React.FC<MobileHeaderProps> = ({ 
  player, gameTime, currentLocation, isSaving, modals, setModals, handleBack, handleExit, onManualSave, isLoading,
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <button 
            ...
            className="px-2 py-2.5 bg-amber-500/10 border border-amber-500/40 text-amber-400 rounded-xl mono text-[10px] font-black uppercase active:scale-95 transition-all"
          >
            🔄 Tải Lại
          </button>
          <button 
