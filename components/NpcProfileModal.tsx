...
export const NpcProfileModal: React.FC<Props> = ({ npc, player, isOpen, genre, onClose, onUpdateNpc, onDeleteNpc, onSwitchNpc, markAsViewed, generateAiAvatar, settings, gameTime }) => {
