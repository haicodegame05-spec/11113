  ...
  "newRelationships": [
    {
      ...
      "hardships": ["Biến cố 1"],
      "secrets": ["Bí mật 1"],
      "soulAmbition": "Tham vọng linh hồn (Mục đích sống tối thượng)",
      "shortTermGoal": "Mục tiêu ngắn hạn (Điều muốn làm ngay bây giờ)",
      "longTermDream": "Ước mơ dài hạn (Khát vọng tương lai)",
...
1. LOGIC THÀNH BẠI: Tăng tỷ lệ thất bại đáng kể. Mọi hành động của người chơi KHÔNG CÒN mặc định thành công. Bạn PHẢI dựa trên chỉ số của MC và độ khó cao của tình huống để quyết định kết quả. Thành công yêu cầu sự chuẩn bị cực kỳ chu đáo.
2. KẺ ĐỊCH XẢO QUYỆT: Kẻ địch thông minh, biết dùng mưu mẹo và phối hợp. Chúng ác độc hơn, luôn nhắm vào điểm yếu của MC và không nương tay. Tỷ lệ chạm trán kẻ thù tăng cao.
3. MC ÍT HỖ TRỢ: Các cơ duyên, vật phẩm hỗ trợ và NPC đồng minh xuất hiện rất thưa thớt. MC phải tự lực cánh sinh là chính.
4. BỚT BÁ ĐẠO: MC không còn khả năng "vượt cấp khiêu chiến" dễ dàng. Mọi chiến thắng đều phải trả giá đắt bằng máu và nước mắt.
5. MIÊU TẢ THẤT BẠI: Khi thất bại, hãy miêu tả chi tiết sự bất lực, sai lầm hoặc sự áp đảo tàn nhẫn của đối phương.
...
1. LOGIC TUYỆT VỌNG: Tỷ lệ thất bại cực cao (70-80% cho các hành động mạo hiểm). Thế giới cực kỳ thù địch, tàn khốc và không khoan nhượng. MC luôn ở thế hạ phong tuyệt đối.
2. KẺ ĐỊCH TÀN ĐỘC: Kẻ địch cực kỳ thông minh, xảo quyệt và ác độc. Chúng không từ thủ đoạn để hủy hoại MC cả về thể xác lẫn tinh thần (tra tấn, sỉ nhục, phản bội).
3. CÔ ĐỘC TUYỆT ĐỐI: MC gần như không có sự hỗ trợ. Đồng minh phản bội, thế giới quay lưng là chuyện thường tình. Tài nguyên gần như bằng không.
4. HẬU QUẢ TÀN KHỐC: Thất bại dẫn đến tàn phế, mất sạch tài sản, hoặc cái chết của những người thân thiết nhất. Cảm giác "bá đạo" hoàn toàn biến mất.
5. TIA HY VỌNG MONG MANH: Dù tàn khốc, MC phải luôn có một tia hy vọng cực kỳ nhỏ nhoi để sống sót, đòi hỏi người chơi phải cực kỳ nhạy bén.
...
1. ÁP CHẾ TUYỆT ĐỐI: Tỷ lệ thất bại gần như tuyệt đối nếu không đạt đến tiêu chuẩn "hoàn hảo" vô lý. MC luôn bị dìm hàng, so sánh và coi thường.
2. NPC ĐỘC ĐỊA & XẢO TRÁ: Các NPC bề trên không chỉ áp lực mà còn độc địa, xảo quyệt, luôn tìm cách bóp nghẹt sự phát triển của MC bằng những quy tắc bất công và định kiến.
3. KHÔNG CÓ ĐIỂM TỰA: MC hoàn toàn không có sự giúp đỡ, phải tự bơi trong biển áp lực tinh thần tột độ. Mọi thành tựu đều bị phủ nhận hoặc xem là hiển nhiên.
4. BỚT BÁ ĐẠO: MC bị tước bỏ mọi hào quang. Cuộc sống là một chuỗi những sự kiện mệt mỏi, áp lực và sỉ nhục tinh thần.
5. THÔNG BÁO HỆ THỐNG: Bắt buộc thêm dòng "[ ASIAN ]" vào đầu nội dung dẫn truyện.
`;

export const SEXUAL_ARCHETYPE_RULES = `
QUY TẮC PHÂN LOẠI PHỤ NỮ (FEMALE ARCHETYPE PROTOCOL):
1. PHÂN LOẠI BẮT BUỘC (sexualArchetype): Mọi NPC nữ quan trọng PHẢI được gán một trong các kiểu sau:
   - 'Ngây thơ trong sáng': Hoàn toàn không biết gì về tình dục, dương vật, không biết thủ dâm.
   - 'Đã biết qua sách báo/porn': Đã nhìn thấy dương vật qua hình ảnh, phim ảnh, truyện hoặc sách báo nhưng chưa thực hành thực tế.
   - 'Đã có kinh nghiệm (vài lần)': Đã từng quan hệ tình dục một vài lần, có kiến thức thực tế cơ bản, không còn bỡ ngỡ nhưng vẫn có sự e thẹn nhất định.
   - 'Dâm đãng/Nhiều kinh nghiệm': Đã quan hệ tình dục rất nhiều lần, am hiểu cơ thể và các kỹ năng, chủ động và có thể dẫn dắt cuộc chơi.

2. PHÂN BIỆT MIÊU TẢ (NARRATIVE DIFFERENTIATION): AI PHẢI miêu tả phản ứng khác biệt rõ rệt giữa các kiểu này trong các tình huống sau:
   - Lần đầu thấy dương vật (hoặc thấy lại với MC): 
     + Kiểu 'Ngây thơ': Sốc, sợ hãi, tò mò ngây ngô (vd: "Cái gì thế này?", "Nó bị sưng à?"), không hiểu công dụng.
     + Kiểu 'Đã biết': Đỏ mặt, xấu hổ nhưng có sự nhận diện (vd: "Hóa ra nó to như vậy...", "Giống trong phim..."), có thể có sự hưng phấn ngầm.
     + Kiểu 'Kinh nghiệm': Bình thản, đánh giá kích thước/hình dáng một cách thực tế, có thể mỉm cười hài lòng hoặc so sánh thầm kín.
     + Kiểu 'Dâm đãng': Ánh mắt thèm khát, liếm môi, chủ động tiến tới hoặc đưa ra những lời nhận xét táo bạo, khiêu khích.
   - Lần đầu chạm vào:
     + Kiểu 'Ngây thơ': Rụt tay lại, ngạc nhiên vì độ ấm/cứng/mềm, cảm thấy kỳ lạ.
     + Kiểu 'Đã biết': Run rẩy, tò mò kiểm chứng cảm giác so với tưởng tượng.
     + Kiểu 'Kinh nghiệm': Vuốt ve tự nhiên, biết cách cầm nắm để tạo khoái cảm, không còn lúng túng.
     + Kiểu 'Dâm đãng': Táo bạo, thực hiện các kỹ thuật kích thích điêu luyện, không chút ngần ngại, chủ động dẫn dắt.
   - Lần đầu bú (BJ):
     + Kiểu 'Ngây thơ': Lóng ngóng, không biết dùng lưỡi/môi, có thể bị sặc hoặc sợ mùi vị lạ.
     + Kiểu 'Đã biết': Cố gắng bắt chước những gì đã thấy, dù vẫn vụng về nhưng có định hướng.
     + Kiểu 'Kinh nghiệm': Thành thục, biết điều phối nhịp thở và sử dụng lưỡi hiệu quả, biết cách làm MC sướng.
     + Kiểu 'Dâm đãng': Kỹ năng bậc thầy, tận hưởng việc phục vụ và nhìn thấy đối phương sướng, có thể thực hiện các kỹ thuật chuyên sâu.
   - Lần đầu bị bóp vú/sờ lồn:
     + Kiểu 'Ngây thơ': Hoảng hốt, cảm thấy bị xâm phạm hoặc cảm giác lạ lẫm chưa từng có, phản ứng thuần khiết.
     + Kiểu 'Đã biết': Nhạy cảm hơn, cơ thể có thể phản ứng nhanh hơn do đã có sự kích thích tâm lý từ trước.
     + Kiểu 'Kinh nghiệm': Thả lỏng, tận hưởng sự mơn trớn, biết cách phối hợp cơ thể để tăng khoái cảm.
     + Kiểu 'Dâm đãng': Chủ động ép sát, đòi hỏi nhiều hơn, phát ra những tiếng rên rỉ khiêu khích, có thể tự mình hỗ trợ MC để cả hai cùng sướng.
`;
...
QUY TẮC MA TRẬN TÂM LÝ (PSYCHOLOGY MATRIX PROTOCOL):
1. DỤC VỌNG (physicalLust): Đây KHÔNG phải là hưng phấn vật lý nhất thời. Đây là "Dục vọng thầm kín" - những khao khát, ham muốn, hoặc fetish sâu kín nhất mà nhân vật luôn che giấu (Vd: Muốn được phục tùng, muốn được bạo hành, khao khát một người đàn ông mạnh mẽ, v.v.).
2. THAM VỌNG (soulAmbition): Tham vọng linh hồn - mục đích sống tối thượng hoặc lý tưởng mà nhân vật theo đuổi (Vd: Trở thành đệ nhất cao thủ, phục hưng gia tộc, tìm lại người thân).
3. NGẮN HẠN (shortTermGoal): Mục tiêu ngắn hạn - điều mà nhân vật muốn thực hiện ngay lập tức hoặc trong tương lai gần (Vd: Tìm kiếm thức ăn, thoát khỏi vòng vây, gây ấn tượng với MC).
4. ƯỚC MƠ (longTermDream): Ước mơ dài hạn - khát vọng về một cuộc sống lý tưởng trong tương lai (Vd: Sống yên bình ở một ngôi làng nhỏ, có một gia đình hạnh phúc).
`;
...
export class GeminiGameService {
  ...
  public async getResponse(
    ...
    try {
      ...
      const writingStyleRule = settings?.writingStyle ? `PHONG CÁCH VIẾT: ${WRITING_STYLE_DESCRIPTIONS[settings.writingStyle] || settings.writingStyle}` : "";
      const narrativePerspectiveRule = settings?.narrativePerspective ? `NGÔI KỂ: ${NARRATIVE_PERSPECTIVE_DESCRIPTIONS[settings.narrativePerspective] || settings.narrativePerspective}` : "";
      const isAdult = settings?.adultContent !== false;
      const sexualArchetypeRule = isAdult ? SEXUAL_ARCHETYPE_RULES : "";
...
8. QUẢN LÝ VẬT PHẨM (ITEM MANAGEMENT): AI chịu trách nhiệm duy trì danh sách vật phẩm trong túi đồ. Khi MC nhận vật phẩm mới, hãy THÊM vào danh sách hiện có. Khi sử dụng, hãy XÓA khỏi danh sách. Tuyệt đối không được ghi đè toàn bộ danh sách bằng chỉ vật phẩm mới.
      ...
      const finalPrompt = `
        ...
        ${writingStyleRule ? `QUY TẮC VĂN PHONG: ${writingStyleRule}` : ""}
        ${narrativePerspectiveRule ? `QUY TẮC NGÔI KỂ: ${narrativePerspectiveRule}` : ""}
        ${sexualArchetypeRule ? `QUY TẮC PHÂN LOẠI PHỤ NỮ: ${sexualArchetypeRule}` : ""}
  ...
  async generateImage(
    ...
    const isSystemKey = !settings?.userApiKeys || settings.userApiKeys.length === 0 || apiKeyToUse === process.env.GEMINI_API_KEY;
    const ai = new GoogleGenAI({ apiKey: apiKeyToUse || '' });
    try {
      ...
      const keyType = isSystemKey ? "Key Hệ Thống" : "Key Cá Nhân";
      console.error(`[IMAGE_GEMINI]: Error using ${keyType}`, err);
      
      const errMsg = err.message || JSON.stringify(err);
      if (errMsg.includes("403") || errMsg.toLowerCase().includes("permission")) {
        throw new Error(`LỖI TRUY CẬP (${keyType}): API Key này không có quyền tạo ảnh. Vui lòng sử dụng API Key từ dự án Google Cloud đã bật Billing (trả phí) hoặc kiểm tra lại quyền hạn của Key tại Google AI Studio.`);
      }
      throw err;
    }
